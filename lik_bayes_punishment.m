function lik = lik_bayes_punishment(P,data)

    % Likelihood function for Bayesian learning agent on two-armed bandit
    %
    % USAGE: lik = lik_bayes_punishment(P,data)
    %
    % INPUTS:
    ...
    %          .C - [N x 1] choices
    %          .O - [N x 1] punishments (coded as -1)
    %
    % OUTPUTS:
    %   lik - [S x 1] log-likelihoods
    %
    % Paul Sharp adapted from Eran Eldar, May 2019
